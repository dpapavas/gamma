...
test_target_0() {
    run -c "target" \
        | viewports 1 "0, 0" "1000, 1000" "0, 0, 0" "0, 0, 0" 0.7 90 "" "*"
}
test_target_1() {
    run -c "target other" \
        | viewports 1 "0, 0" "1000, 1000" "0, 0, 0" "0, 0, 0" 0.7 90 other "*"
}
...
test_focus() {
    run -c "split" -c "focus 2" -c "target other" \
        | viewports 1 "0, 0" "500, 1000" "0, 0, 0" "0, 0, 0" 0.7 90 test "" \
                    2 "500, 0" "500, 1000" "0, 0, 0" "0, 0, 0" 0.7 90 other "*"
}
...
test_rotate_0() {
    run -c "rotate 5 10 15" -c "rotate" \
        | viewports 1 "0, 0" "1000, 1000" "0, 0, 0" "0, 0, 0" 0.7 90 test "*"
}

test_rotate_1() {
    run -c "rotate 30" \
        | viewports 1 "0, 0" "1000, 1000" "0, 0, 0" "30, 0, 0" 0.7 90 test "*"
}

test_rotate_2() {
    run -c "rotate 30 40" \
        | viewports 1 "0, 0" "1000, 1000" "0, 0, 0" "30, 40, 0" 0.7 90 test "*"
}

test_rotate_3() {
    run -c "rotate 30 40 50" \
        | viewports 1 "0, 0" "1000, 1000" "0, 0, 0" "30, 40, 50" 0.7 90 test "*"
}
...
test_translate_1() {
    run -c "translate 1.2" \
        | viewports 1 "0, 0" "1000, 1000" "1.2, 0, 0" "0, 0, 0" 0.7 90 test "*"
}

test_translate_2() {
    run -c "translate 1.2 3.4" \
        | viewports 1 "0, 0" "1000, 1000" "1.2, 3.4, 0" "0, 0, 0" 0.7 90 test "*"
}

test_translate_3() {
    run -c "translate 1.2 3.4 5.6" \
        | viewports 1 "0, 0" "1000, 1000" "1.2, 3.4, 5.6" "0, 0, 0" 0.7 90 test "*"
}
...
test_pan_1() {
    run -c "rotate 90 0 90" -c "pan 1" \
        | viewports 1 "0, 0" "1000, 1000" "0, 0, 1" "90, 0, 90" 0.7 90 test "*"
}

test_pan_2() {
    run -c "rotate 90 0 90" -c "pan 1 2" \
        | viewports 1 "0, 0" "1000, 1000" "2, 0, 1" "90, 0, 90" 0.7 90 test "*"
}
...
test_zoom_1() {
    run -c "zoom 0.5" \
        | viewports 1 "0, 0" "1000, 1000" "0, 0, 0" "0, 0, 0" 1.2 90 test "*"
}
...
test_split_1() {
    run -c "split" \
        | viewports 1 "0, 0" "500, 1000" "0, 0, 0" "0, 0, 0" 0.7 90 test "*" \
                    2 "500, 0" "500, 1000" "0, 0, 0" "0, 0, 0" 0.7 90 "" ""
}

test_split_2() {
    run -c "split vertically 2" \
        | viewports 1 "0, 0" "1000, 500" "0, 0, 0" "0, 0, 0" 0.7 90 test "*" \
                    2 "0, 500" "1000, 500" "0, 0, 0" "0, 0, 0" 0.7 90 "" ""
}
...
test_split_3() {
    run -c "split horizontally 4" \
        | viewports 1 "0, 0" "250, 1000" "0, 0, 0" "0, 0, 0" 0.7 90 test "*" \
                    ...
                    3 "500, 0" "250, 1000" "0, 0, 0" "0, 0, 0" 0.7 90 "" "" \
                    4 "750, 0" "250, 1000" "0, 0, 0" "0, 0, 0" 0.7 90 "" ""
}

test_split_4() {
    run -c "split vertically 4" \
        | viewports 1 "0, 0" "1000, 250" "0, 0, 0" "0, 0, 0" 0.7 90 test "*" \
                    2 "0, 250" "1000, 250" "0, 0, 0" "0, 0, 0" 0.7 90 "" "" \
                    3 "0, 500" "1000, 250" "0, 0, 0" "0, 0, 0" 0.7 90 "" "" \
                    4 "0, 750" "1000, 250" "0, 0, 0" "0, 0, 0" 0.7 90 "" ""
}
