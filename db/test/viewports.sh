...
viewports() {
    match \# Orig. Size Trans. Rotation Zoom Pr. Name Flags ""
...
test_target_0() {
    run -c "target" |
        viewports 1 "0, 0" "1000, 1000" "0, 0, 0" "0, 0, 0" 0.7 50 "" " vef" "*"
}
test_target_1() {
    run -c "target other" |
        viewports 1 "0, 0" "1000, 1000" "0, 0, 0" "0, 0, 0" 0.7 50 other " vef" "*"
}
...
test_focus() {
    run -c "split" -c "focus 2" -c "target other" |
        viewports 1 "0, 0" "500, 1000" "0, 0, 0" "0, 0, 0" 0.7 50 test " vef" "" \
                    2 "500, 0" "500, 1000" "0, 0, 0" "0, 0, 0" 0.7 50 other " vef" "*"
}
...
test_rotate_1() {
    run -c "rotate 30" |
        viewports 1 "0, 0" "1000, 1000" "0, 0, 0" "30, 0, 0" 0.7 50 test " vef" "*"
}

test_rotate_2() {
    run -c "rotate 30 40" |
        viewports 1 "0, 0" "1000, 1000" "0, 0, 0" "30, 40, 0" 0.7 50 test " vef" "*"
}

test_rotate_3() {
    run -c "rotate 30 40 50" |
        viewports 1 "0, 0" "1000, 1000" "0, 0, 0" "30, 40, 50" 0.7 50 test " vef" "*"
}
...
test_translate_1() {
    run -c "translate 1.2" |
        viewports 1 "0, 0" "1000, 1000" "1.2, 0, 0" "0, 0, 0" 0.7 50 test " vef" "*"
}

test_translate_2() {
    run -c "translate 1.2 3.4" |
        viewports 1 "0, 0" "1000, 1000" "1.2, 3.4, 0" "0, 0, 0" 0.7 50 test " vef" "*"
}
...
test_zoom_1() {
    run -c "zoom 0.5" |
        viewports 1 "0, 0" "1000, 1000" "0, 0, 0" "0, 0, 0" 1.2 50 test " vef" "*"
}
...
test_view_1() {
    run -c "view orthographic" |
        viewports 1 "0, 0" "1000, 1000" "0, 0, 0" "0, 0, 0" 0.7 "Or." test " vef" "*"
}
...
test_view_3() {
    run -c "view 70" |
        viewports 1 "0, 0" "1000, 1000" "0, 0, 0" "0, 0, 0" 0.7 70 test " vef" "*"
}
...
test_split_1() {
    run -c "split" |
        viewports 1 "0, 0" "500, 1000" "0, 0, 0" "0, 0, 0" 0.7 50 test " vef" "*" \
                  2 "500, 0" "500, 1000" "0, 0, 0" "0, 0, 0" 0.7 50 2 " vef" ""
}

test_split_2() {
    run -c "split vertically 2" |
        viewports 1 "0, 0" "1000, 500" "0, 0, 0" "0, 0, 0" 0.7 50 test " vef" "*" \
                  2 "0, 500" "1000, 500" "0, 0, 0" "0, 0, 0" 0.7 50 2 " vef" ""
}

test_split_3() {
    run -c "split horizontally 4" |
        viewports 1 "0, 0" "250, 1000" "0, 0, 0" "0, 0, 0" 0.7 50 test " vef" "*" \
                  2 "250, 0" "250, 1000" "0, 0, 0" "0, 0, 0" 0.7 50 2 " vef" "" \
                  3 "500, 0" "250, 1000" "0, 0, 0" "0, 0, 0" 0.7 50 3 " vef" "" \
                  4 "750, 0" "250, 1000" "0, 0, 0" "0, 0, 0" 0.7 50 4 " vef" ""
}

test_split_4() {
    run -c "split vertically 4" |
        viewports 1 "0, 0" "1000, 250" "0, 0, 0" "0, 0, 0" 0.7 50 test " vef" "*" \
                  2 "0, 250" "1000, 250" "0, 0, 0" "0, 0, 0" 0.7 50 2 " vef" "" \
                  3 "0, 500" "1000, 250" "0, 0, 0" "0, 0, 0" 0.7 50 3 " vef" "" \
                  4 "0, 750" "1000, 250" "0, 0, 0" "0, 0, 0" 0.7 50 4 " vef" ""
}
...
test_split_5() {
    run -c "split horizontally 4 2" |
        viewports 1 "0, 0" "250, 1000" "0, 0, 0" "0, 0, 0" 0.7 50 test " vef" "*" \
                  2 "250, 0" "250, 1000" "0, 0, 0" "0, 0, 0" 0.7 50 2 " vef" "" \
                  3 "500, 0" "500, 1000" "0, 0, 0" "0, 0, 0" 0.7 50 3 " vef" ""
}

test_target_option() {
    run --target "other" -c "window other" |
        viewports 1 "0, 0" "499, 499" "0, 0, 0" "0, 0, 0" 0.7 50 other " vef" "*"
}

test_toggle() {
    while IFS=: read a b; do
        run -c "toggle $a" |
            viewports 1 "0, 0" "1000, 1000" "0, 0, 0" "0, 0, 0" 0.7 50 test "$b" "*" ||
            return 1
    done <<EOF
    maximized:mvef
    vertices:  ef
