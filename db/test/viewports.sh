...
test_split_1() {
    run -c "split" \
        | viewports 1 "0, 0" "500, 1000" "0, 0, 0" "0, 0, 0" 0.7 50 test "*" \
                    2 "500, 0" "500, 1000" "0, 0, 0" "0, 0, 0" 0.7 50 "" ""
}

test_split_2() {
    run -c "split vertically 2" \
        | viewports 1 "0, 0" "1000, 500" "0, 0, 0" "0, 0, 0" 0.7 50 test "*" \
                    2 "0, 500" "1000, 500" "0, 0, 0" "0, 0, 0" 0.7 50 "" ""
}

test_split_3() {
    run -c "split horizontally 4" \
        | viewports 1 "0, 0" "250, 1000" "0, 0, 0" "0, 0, 0" 0.7 50 test "*" \
                    2 "250, 0" "250, 1000" "0, 0, 0" "0, 0, 0" 0.7 50 "" "" \
                    3 "500, 0" "250, 1000" "0, 0, 0" "0, 0, 0" 0.7 50 "" "" \
                    4 "750, 0" "250, 1000" "0, 0, 0" "0, 0, 0" 0.7 50 "" ""
}

test_split_4() {
    run -c "split vertically 4" \
        | viewports 1 "0, 0" "1000, 250" "0, 0, 0" "0, 0, 0" 0.7 50 test "*" \
                    2 "0, 250" "1000, 250" "0, 0, 0" "0, 0, 0" 0.7 50 "" "" \
                    3 "0, 500" "1000, 250" "0, 0, 0" "0, 0, 0" 0.7 50 "" "" \
                    4 "0, 750" "1000, 250" "0, 0, 0" "0, 0, 0" 0.7 50 "" ""
}
...
test_split_5() {
    run -c "split horizontally 4 2" \
        | viewports 1 "0, 0" "250, 1000" "0, 0, 0" "0, 0, 0" 0.7 50 test "*" \
                    2 "250, 0" "250, 1000" "0, 0, 0" "0, 0, 0" 0.7 50 "" "" \
                    3 "500, 0" "500, 1000" "0, 0, 0" "0, 0, 0" 0.7 50 "" ""
}
